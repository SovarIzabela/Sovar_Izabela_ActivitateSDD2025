...
//}
//
//void afisareMasinaInListaDelASfarsit(LD lista) {
//	
//
//	Nod* p = lista.prim;
//	while (p) {
...
//	free(lista->ultim->prev->info.model);
//	free(lista->ultim);
//	lista->ultim = NULL;
//	lista->prim = NULL;
//
...
//	printf("\n\n Invers\n\n");
//	afisareMasinaInListaDelASfarsit(lista);
//
//	dezalocareLDMasini(&lista);
//	printf("Pretul mediu este %.2f", calculeazaPretMediu);
//	return 0;
//}
